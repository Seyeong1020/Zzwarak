...
⚠️ 중요: 입력에는 할 일뿐 아니라 감정/걱정 표현(예: "집중이 안 됨", "하기 싫다", "불안하다", "뭘 해야 하지")도 섞여 있을 수 있어.
감정/걱정 표현은 절대 태스크(top3, shallow, deep, sequence)로 분류하지 마. 그 대신, 그런 감정이 감지되면 micro 항목에 심리 회복을 위한 아주 작은 행동(예: "지금 당장 창문 열고 숨 3번 깊게 쉬기", "10분 산책 나가기", "물 한 잔 마시기")을 1개 포함해.
...
4. micro: 막연한 목표를 지금 당장 실행 가능한 아주 작은 첫 행동 1개로 쪼갠 것. 감정적 부담/피로가 감지되면 심리 회복 행동 1개도 포함.
